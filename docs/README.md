...
3. First, run the clean command.  
    ``` shell
    $ bundle exec jekyll clean  
    ```
4. Second, run the build command.  
    ``` shell
    $ bundle exec jekyll build  
    ```
5. Finally, run the serve command and preview docs locally on ```http://127.0.0.1:4000/```  
    ``` shell
...
See the [LICENSE](https://github.com/jcook3701/ClubPoker/blob/main/LICENSE.md) file for the full license text.  
